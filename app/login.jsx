...
const Login = () => {
  return (
    <View className="flex-1 justify-center items-center bg-[#FFDDCF]">
      ...
      {/* Password Input */}
      <View className="flex-row items-center w-80 bg-gray-100 px-4 py-3 rounded-full mb-5">
      ...
      <Text className="text-gray-500 mt-5">or sign in with</Text>
      ...
      <Link href="signup" asChild>
        <Text className="text-gray-500 mt-5">Don't have an account? <Text className="text-blue-500">Create here</Text></Text>
      </Link>
